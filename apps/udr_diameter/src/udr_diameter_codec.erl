...
%% Generated by gen_dict.sh from dia/diameter_3gpp_s6a.dia; provides the
%% enumerated-AVP value macros (?'S6A_CANCELLATION-TYPE_*' etc.) so the symbolic
%% 3GPP names come from the dictionary instead of magic integers in this module.
...
clr_request(#{imsi := Imsi, mme_host := Host, mme_realm := Realm}) ->
    #{'User-Name' => Imsi,
      ...
      'Cancellation-Type' => ?'S6A_CANCELLATION-TYPE_SUBSCRIPTION_WITHDRAWAL'}.
